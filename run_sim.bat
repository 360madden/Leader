...
title 🛰️ Leader Bridge Simulator
echo ========================================
echo   🛰️ LEADER: LAUNCHING SIMULATOR...
echo ========================================
...
bin\Release\net9.0\LeaderDecoder.exe --sim %*
set "EXIT_CODE=%ERRORLEVEL%"
if %EXIT_CODE% NEQ 0 (
    call "%ROOT%log_launcher_failure.bat" "%ROOT%" "%LAUNCHER%" "launch" "%EXIT_CODE%" "LeaderDecoder.exe --sim exited with a non-zero code."
)
